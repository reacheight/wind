...
import wind.models.{AnalysisState, AnalysisStatus, Fight, GameTimeState, HeroId, PlayerId}
...
//  implicit def analysisResultEncoder: Encoder[AnalysisResultInternal] = (analysis: AnalysisResultInternal) => Json.obj(
//    "info" -> Json.obj(
